...
@Service
public class XEnlacesService {

    // Ruta base para los archivos de configuración
    private final String baseConfigPath = "D:/Joeseep/web_scrap/Selenium_scrape/twitter_scrape/";
    private static final String LIMITADOR_FILE = "D:/Joeseep/web_scrap/Selenium_scrape/twitter_scrape/limitador.conf";
