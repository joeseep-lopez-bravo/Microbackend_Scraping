...
@Service
public class IGEnlacesService {

    // Ruta base para los archivos de configuración
    private final String baseConfigPath = "D:/Joeseep/web_scrap/Selenium_scrape/instagram_scrape/";
    private static final String LIMITADOR_FILE = "D:/Joeseep/web_scrap/Selenium_scrape/instagram_scrape/limitador.conf";
