...
import com.solusoftec.services.twitter.XImagenService;
...
@RestController
@RequestMapping("/X/imagenes")
@CrossOrigin(origins = "http://localhost:3000")
public class XImagenController {

    @Autowired
    private XImagenService imagenService;

    private static final Path IMG_BASE_PATH = Paths.get("D:\\Joeseep\\web_scrap\\Selenium_scrape\\twitter_scrape\\imagenes_descargadas");
    ...
    @GetMapping("/{id}")
    public ResponseEntity<XImagen> getImagenById(@PathVariable Integer id) {
        Optional<XImagen> imagen = imagenService.getImagenById(id);
